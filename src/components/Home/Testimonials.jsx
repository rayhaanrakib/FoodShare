                                        ...
                                        <figure className="relative z-10">
                                            ...
                                            <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-primary">
                                                ...
                                                <div className="flex items-center gap-4 pt-4 text-sm text-primary">
                                                    <img
                                                        src="https://bighearts.wgl-demo.net/wp-content/uploads/2020/08/testimonials_03-60x60.jpg"
                                                        alt="user name"
                                                        title="user name"
                                                        width="48"
                                                        height="48"
                                    ...
                                    <div className="relative p-6">
                                        <figure className="relative z-10">
                                            ...
                                            <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-primary">
                                                ...
                                                <div className="flex items-center gap-4 pt-4 text-sm text-primary">
                                                    <img
                                                        src="https://bighearts.wgl-demo.net/wp-content/uploads/2020/09/testimonials_02-2-60x60.jpg"
                                                        alt="user name"
                                                        title="user name"
                                                        width="48"
                                                        height="48"
                                    ...
                                    <div className="relative p-6">
                                        <figure className="relative z-10">
                                            ...
                                            <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-primary">
                                                ...
                                                <div className="flex items-center gap-4 pt-4 text-sm text-primary">
                                                    <img
                                                        src="https://bighearts.wgl-demo.net/wp-content/uploads/2020/08/testimonials_04-60x60.jpg"
                                                        alt="user name"
                                                        title="user name"
                                                        width="48"
                                                        height="48"
