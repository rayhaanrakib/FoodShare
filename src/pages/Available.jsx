...
const Available = () => {
    ...
    const url = `/filter/services?status=1&search=${search}&sort=${asc ? 'asc' : 'desc'}&quantity=${less ? 'asc' : 'desc'}`;
    useEffect(() => {
        setAllFoods([])
        axiosSecure.get(url)
            .then(res => {
    ...
    return (
        <div className='container mx-auto min-h-screen'>
            <Helmet><title>Food Connect | Available Foods</title></Helmet>
            <div className=''>
                <div class="relative overflow-hidden">
                    <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-24">
                        <div class="text-center">
                            <h1 class="text-4xl sm:text-6xl font-bold text-secondary">
                                <Fade cascade damping={0.1}> Available Foods</Fade>
                            </h1>

                            <p class="mt-3 text-gray-600 ">
                                <Fade damping={0.1}>Discover a Variety of Fresh Donations</Fade>
                            </p>
                            ...
                            <div class="mt-7 sm:mt-12 mx-auto max-w-xl relative">
                                ...
                                <form onSubmit={handleSearch}>
                                    <div class="relative z-10 flex space-x-3 p-3 bg-white border rounded-lg shadow-lg shadow-gray-100 ">
                                        ...
                                        <div class="flex-[0_0_auto]">
                                            <div class="grid">
                                                <button type="submit" class="w-[46px] h-[46px] inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-primary text-white hover:bg-accnet disabled:opacity-50 disabled:pointer-events-none">
                                ...
                                <div class="hidden md:block absolute bottom-0 start-0 translate-y-10 -translate-x-32">
                                    <svg class="w-40 h-auto text-accent" width="347" height="188" viewBox="0 0 347 188" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className='mt-10'>
                                    {
                                        isLoading ? (<div className='w-full flex justify-center items-center justify-items-center'><img className='w-80' src="https://i.ibb.co/TqhV9yt/loading.gif" alt="" /></div>)
                                            ...
                                            (<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 justify-items-center mt-10'>
                                                {
                                                    allFoods?.map(food => <FoodCard align="center" key={food._id} food={food}></FoodCard>)
                                                }
                                            </div>)
                                    }
                                </div>
