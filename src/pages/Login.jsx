...
const Login = () => {
    ...
    return (
        <div className="min-h-screen px-[3vw] flex items-center justify-center -mt-24">
            <div className='flex flex-col w-96 bg-gray-100/30 shadow gap-5 px-16 py-10 rounded-md my-40'>
                ...
                <form>
                    ...
                    <div class="grid">
                        <button type="submit" class="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-[#FF6C22] text-white hover:bg-[#FF6C22] focus:outline-none focus:ring-2 focus:ring-[#FF6C22] focus:ring-offset-2 transition-all text-smsm:p-4">Sign In</button>
                    </div>
                </form>
                <p class="mt-3 text-sm text-center text-[#50577A]">
                    New to FoodShare.org? <span className='font-semibold hover:text-[#FF6C22]'><NavLink to="/register">Sign Up Now</NavLink></span>
                </p>
            </div>
        </div>
    );
