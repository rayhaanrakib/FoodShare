...
const UpdateFood = () => {
    ...
    const handleUpdate = e => {
        ...
        fetch(`https://foodshare-server-mu.vercel.app/services/${_id}`, {
            method: "PUT",
            headers: {
    ...
    return (
        <div className='py-32 -mt-24 bg-gray-100'>
            <Helmet><title>FoodConnect | Update Food</title></Helmet>
            <div class="container mx-auto flex flex-col lg:flex-row gap-5 justify-end px-4 py-10 sm:px-6 lg:px-6 lg:py-14">
                <div className='hidden lg:block w-1/2 pr-5'>
                    <h2 className='text-2xl font-semibold capitalize mb-6 text-accent'>Update {FoodName}</h2>
                    ...
                    <div class="p-4 sm:p-7 flex flex-col bg-white rounded-2xl shadow-2xl ">
                      ...
                      autofill:pb-2" placeholder="********" />
                        ...
                        peer-[:not(:placeholder-shown)]:-translate-y-1.5">Food Quantity</label>
                            ...
                            <div class="mt-5">
                                <button type="submit" class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded border border-transparent bg-accent text-white hover:bg-accent disabled:opacity-50 disabled:pointer-events-none ">Update Info</button>
                            </div>
                        </div>
                    </div>
                </form>
